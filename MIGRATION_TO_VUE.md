...
* Started composition-component migration:
  ...
  * `@react-spectrum/tabs` -> `@vue-spectrum/tabs` (`in_progress`)
  * `@react-spectrum/tag` -> `@vue-spectrum/tag` (`in_progress`)
  * `@react-spectrum/toast` -> `@vue-spectrum/toast` (`in_progress`)
  * `@react-spectrum/tooltip` -> `@vue-spectrum/tooltip` (`in_progress`)
  * `@react-spectrum/utils` -> `@vue-spectrum/utils` (`in_progress`)
  * `@react-spectrum/test-utils` -> `@vue-spectrum/test-utils` (`in_progress`)
  * `@react-spectrum/theme-dark` -> `@vue-spectrum/theme-dark` (`in_progress`)
  * `@react-spectrum/theme-default` -> `@vue-spectrum/theme-default` (`in_progress`)
  * `@react-spectrum/theme-express` -> `@vue-spectrum/theme-express` (`in_progress`)
  * `@react-spectrum/theme-light` -> `@vue-spectrum/theme-light` (`in_progress`)
  * `@react-spectrum/story-utils` -> `@vue-spectrum/story-utils` (`in_progress`)
  * `@react-spectrum/style-macro-s1` -> `@vue-spectrum/style-macro-s1` (`in_progress`)
* Started data-heavy migration:
  ...
  * `@react-spectrum/steplist` -> `@vue-spectrum/steplist` (`in_progress`)
* Started React Aria package migration:
  ...
  * `@react-aria/menu` -> `@vue-aria/menu` (`in_progress`)
  * `@react-aria/meter` -> `@vue-aria/meter` (`in_progress`)
  * `@react-aria/numberfield` -> `@vue-aria/numberfield` (`in_progress`)
  * `@react-aria/overlays` -> `@vue-aria/overlays` (`in_progress`)
  * `@react-aria/progress` -> `@vue-aria/progress` (`in_progress`)
  * `@react-aria/radio` -> `@vue-aria/radio` (`in_progress`)
  * `@react-aria/searchfield` -> `@vue-aria/searchfield` (`in_progress`)
  * `@react-aria/select` -> `@vue-aria/select` (`in_progress`)
  * `@react-aria/selection` -> `@vue-aria/selection` (`in_progress`)
  * `@react-aria/separator` -> `@vue-aria/separator` (`in_progress`)
  * `@react-aria/slider` -> `@vue-aria/slider` (`in_progress`)
  * `@react-aria/spinbutton` -> `@vue-aria/spinbutton` (`in_progress`)
  * `@react-aria/ssr` -> `@vue-aria/ssr` (`in_progress`)
  * `@react-aria/steplist` -> `@vue-aria/steplist` (`in_progress`)
  * `@react-aria/switch` -> `@vue-aria/switch` (`in_progress`)
  * `@react-aria/toggle` -> `@vue-aria/toggle` (`in_progress`)
  * `@react-aria/toolbar` -> `@vue-aria/toolbar` (`in_progress`)
  * `@react-aria/tooltip` -> `@vue-aria/tooltip` (`in_progress`)
  * `@react-aria/tree` -> `@vue-aria/tree` (`in_progress`)
  * `@react-aria/utils` -> `@vue-aria/utils` (`in_progress`)
  * `@react-aria/visually-hidden` -> `@vue-aria/visually-hidden` (`in_progress`)
  * `@react-aria/tag` -> `@vue-aria/tag` (`in_progress`)
  * `@react-aria/test-utils` -> `@vue-aria/test-utils` (`in_progress`)
  * `@react-aria/textfield` -> `@vue-aria/textfield` (`in_progress`)
  * `@react-aria/toast` -> `@vue-aria/toast` (`in_progress`)
  * `@react-aria/tabs` -> `@vue-aria/tabs` (`in_progress`)
  * `@react-aria/table` -> `@vue-aria/table` (`in_progress`)
...
* Started React Stately package migration:
  * `@react-stately/autocomplete` -> `@vue-stately/autocomplete` (`in_progress`)
  * `@react-stately/calendar` -> `@vue-stately/calendar` (`in_progress`)
  * `@react-stately/checkbox` -> `@vue-stately/checkbox` (`in_progress`)
  * `@react-stately/combobox` -> `@vue-stately/combobox` (`in_progress`)
  * `@react-stately/collections` -> `@vue-stately/collections` (`in_progress`)
  * `@react-stately/color` -> `@vue-stately/color` (`in_progress`)
  * `@react-stately/data` -> `@vue-stately/data` (`in_progress`)
  * `@react-stately/datepicker` -> `@vue-stately/datepicker` (`in_progress`)
  * `@react-stately/disclosure` -> `@vue-stately/disclosure` (`in_progress`)
  * `@react-stately/dnd` -> `@vue-stately/dnd` (`in_progress`)
  * `@react-stately/flags` -> `@vue-stately/flags` (`in_progress`)
  * `@react-stately/form` -> `@vue-stately/form` (`in_progress`)
  * `@react-stately/grid` -> `@vue-stately/grid` (`in_progress`)
  * `@react-stately/layout` -> `@vue-stately/layout` (`in_progress`)
  * `@react-stately/list` -> `@vue-stately/list` (`in_progress`)
  * `@react-stately/menu` -> `@vue-stately/menu` (`in_progress`)
  * `@react-stately/numberfield` -> `@vue-stately/numberfield` (`in_progress`)
  * `@react-stately/overlays` -> `@vue-stately/overlays` (`in_progress`)
  * `@react-stately/radio` -> `@vue-stately/radio` (`in_progress`)
  * `@react-stately/searchfield` -> `@vue-stately/searchfield` (`in_progress`)
  * `@react-stately/select` -> `@vue-stately/select` (`in_progress`)
  * `@react-stately/selection` -> `@vue-stately/selection` (`in_progress`)
  * `@react-stately/slider` -> `@vue-stately/slider` (`in_progress`)
  * `@react-stately/steplist` -> `@vue-stately/steplist` (`in_progress`)
...
* Started Vue test adaptation:
  ...
  * Added composition coverage for `accordion`, `actionbar`, `actiongroup`, `breadcrumbs`, `calendar`, `card`, `color`, `contextualhelp`, `datepicker`, `picker`, `dialog`, `overlays`, `menu`, `listbox`, `list`, `tabs`, `tag`, `combobox`, `autocomplete`, `story-utils`, `test-utils`, `theme-dark`, `theme-default`, `theme-express`, `theme-light`, `utils`, `style-macro-s1`, `@vue-stately/autocomplete`, `@vue-stately/calendar`, `@vue-stately/checkbox`, `@vue-stately/collections`, `@vue-stately/color`, `@vue-stately/combobox`, `@vue-stately/data`, `@vue-stately/datepicker`, `@vue-stately/disclosure`, `@vue-stately/dnd`, `@vue-stately/flags`, `@vue-stately/form`, `@vue-stately/grid`, `@vue-stately/layout`, `@vue-stately/list`, `@vue-stately/menu`, `@vue-stately/numberfield`, `@vue-stately/overlays`, `@vue-stately/radio`, `@vue-stately/searchfield`, `@vue-stately/select`, `@vue-stately/selection`, `@vue-stately/slider`, `@vue-stately/steplist`, `@vue-stately/table`, and `@vue-stately/tabs`.
