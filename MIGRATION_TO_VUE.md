...
* Started Vue test adaptation:
  * `starters/vue` runs Vitest + Vue Test Utils interaction tests for `button`, `buttongroup`, `textfield`, `checkbox`, `radio`, `switch`, `tabs`, `tag`, `layout`, `labeledvalue`, `illustratedmessage`, and `icon`.
