import '@adobe/spectrum-css-temp/vars/spectrum-dark.css';
...
export const theme: Theme = {
  global: {
    className: resolveClassName(global, 'spectrum', 'spectrum-dark-global')
  },
  light: {
    className: resolveClassName(dark, 'spectrum--dark', 'spectrum-dark'),
    colorScheme: 'dark'
  },
  dark: {
