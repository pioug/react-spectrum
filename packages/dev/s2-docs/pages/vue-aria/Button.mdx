...
```tsx render hideImports files={["starters/vue/src/snippets/ButtonPending.vue"]} defaultSelected="ButtonPending.vue" hideExtraFiles
"use client";
import {useState} from 'react';
import {VueButtonExample as Button} from '../../src/VueInterop';
...
```tsx render hideImports files={["starters/vue/src/snippets/ButtonLink.vue"]} defaultSelected="ButtonLink.vue" hideExtraFiles
"use client";
