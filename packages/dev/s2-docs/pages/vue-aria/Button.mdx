...
```tsx render snippetFile="starters/vue/src/snippets/ButtonEvents.vue"
"use client";
...
function Example() {
  ...
  return (
    <>
      <Button
        /*- begin highlight -*/
        onPressStart={event => setPointerType((event as {pointerType: string}).pointerType)}
...
```tsx render snippetFile="starters/vue/src/snippets/ButtonPending.vue"
"use client";
import {useState} from 'react';
import {VueButtonExample as Button} from '../../src/VueInterop';
...
```tsx render hideImports snippetFile="starters/vue/src/snippets/ButtonLink.vue"
"use client";
