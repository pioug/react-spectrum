...
import {VueButtonExample, VueButtonEventsDemo, VueButtonPendingDemo, VueLinkButtonDemo} from '../../src/VueInterop';
...
<template>
  <VueButton
    @press-start="event => pointerType = event.pointerType"
    @press-end="() => pointerType = ''">
    Press me
  </VueButton>
...
<template>
  <VueLink class="react-aria-Button button-base" href="https://adobe.com/" target="_blank">
    Adobe
  </VueLink>
</template>
```
