...
* `packages/@vue-stately/autocomplete`, `packages/@vue-stately/calendar`, and `packages/@vue-stately/checkbox` start React Stately state migration on the Vue layer.
