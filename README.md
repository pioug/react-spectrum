...
* `packages/@vue-aria/actiongroup`, `packages/@vue-aria/autocomplete`, `packages/@vue-aria/breadcrumbs`, `packages/@vue-aria/aria-modal-polyfill`, and `packages/@vue-aria/virtualizer` start React Aria composable migration on the Vue layer.
