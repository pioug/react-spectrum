...
* `packages/@vue-stately/autocomplete`, `packages/@vue-stately/calendar`, `packages/@vue-stately/checkbox`, `packages/@vue-stately/collections`, and `packages/@vue-stately/color` start React Stately state migration on the Vue layer.
