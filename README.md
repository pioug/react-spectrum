...
* `packages/@vue-stately/autocomplete`, `packages/@vue-stately/calendar`, `packages/@vue-stately/checkbox`, and `packages/@vue-stately/collections` start React Stately state migration on the Vue layer.
