...
* Current API coverage: `63.88%` (`2672` source exports, `965` missing exports, `72` fully matched packages).
...
* Recently closed API gaps: `@react-aria/interactions`, `@react-aria/color`, `@react-spectrum/provider`, `@react-spectrum/label`, `@react-spectrum/form`, `@react-spectrum/progress`, `@react-spectrum/overlays`, `@react-spectrum/layout`.
