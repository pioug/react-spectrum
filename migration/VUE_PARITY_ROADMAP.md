...
* Current API coverage: `69.42%` (`2672` source exports, `817` missing exports, `152` fully matched packages).
...
* Remaining API gaps are concentrated in `react-aria-components` and `@react-spectrum/s2`.
