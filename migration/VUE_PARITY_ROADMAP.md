...
* Current API coverage: `63.17%` (`2672` source exports, `984` missing exports, `66` fully matched packages).
...
* Recently closed API gaps: `@react-aria/interactions`, `@react-aria/color`.
