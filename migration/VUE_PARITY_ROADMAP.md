...
* Current API coverage: `63.96%` (`2672` source exports, `963` missing exports, `73` fully matched packages).
...
* Recently closed API gaps: `@react-aria/interactions`, `@react-aria/color`, `@react-spectrum/provider`, `@react-spectrum/label`, `@react-spectrum/form`, `@react-spectrum/progress`, `@react-spectrum/overlays`, `@react-spectrum/layout`, `@react-aria/visually-hidden`.
