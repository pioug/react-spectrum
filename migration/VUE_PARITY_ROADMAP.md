...
* Current API coverage: `63.32%` (`2672` source exports, `980` missing exports, `67` fully matched packages).
...
* Recently closed API gaps: `@react-aria/interactions`, `@react-aria/color`, `@react-spectrum/provider`.
