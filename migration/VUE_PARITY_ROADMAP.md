...
* Current API coverage: `65.87%` (`2672` source exports, `912` missing exports, `103` fully matched packages).
...
* Recently closed API gaps: `@react-aria/interactions`, `@react-aria/color`, `@react-spectrum/provider`, `@react-spectrum/label`, `@react-spectrum/form`, `@react-spectrum/progress`, `@react-spectrum/overlays`, `@react-spectrum/layout`, `@react-aria/visually-hidden`, `@react-spectrum/textfield`, `@react-aria/button`, `@react-spectrum/checkbox`, `@react-aria/textfield`, `@react-stately/selection`, `@react-spectrum/datepicker`, `@react-spectrum/actiongroup`, `@react-spectrum/actionbar`, `@react-spectrum/autocomplete`, `@react-spectrum/combobox`, `@react-spectrum/breadcrumbs`, `@react-spectrum/calendar`, `@react-spectrum/contextualhelp`, `@react-spectrum/picker`, `@react-spectrum/searchfield`, `@react-spectrum/tag`, `@react-stately/toggle`, `@react-aria/listbox`, `@react-aria/dialog`, `@react-spectrum/badge`, `@react-spectrum/toast`, `@react-spectrum/dropzone`, `@react-spectrum/filetrigger`, `@react-aria/combobox`, `@react-aria/menu`, `@react-aria/numberfield`, `@react-aria/searchfield`, `@react-spectrum/card`, `@react-spectrum/labeledvalue`, `@react-spectrum/numberfield`.
