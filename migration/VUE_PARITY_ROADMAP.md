...
* Current API coverage: `63.77%` (`2672` source exports, `968` missing exports, `71` fully matched packages).
...
* Recently closed API gaps: `@react-aria/interactions`, `@react-aria/color`, `@react-spectrum/provider`, `@react-spectrum/label`, `@react-spectrum/form`, `@react-spectrum/progress`, `@react-spectrum/overlays`.
