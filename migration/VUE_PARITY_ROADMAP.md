...
* Current API coverage: `64.37%` (`2672` source exports, `952` missing exports, `76` fully matched packages).
...
* Recently closed API gaps: `@react-aria/interactions`, `@react-aria/color`, `@react-spectrum/provider`, `@react-spectrum/label`, `@react-spectrum/form`, `@react-spectrum/progress`, `@react-spectrum/overlays`, `@react-spectrum/layout`, `@react-aria/visually-hidden`, `@react-spectrum/textfield`, `@react-aria/button`, `@react-spectrum/checkbox`.
