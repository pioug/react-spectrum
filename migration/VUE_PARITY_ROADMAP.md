...
* Current API coverage: `64.11%` (`2672` source exports, `959` missing exports, `74` fully matched packages).
...
* Recently closed API gaps: `@react-aria/interactions`, `@react-aria/color`, `@react-spectrum/provider`, `@react-spectrum/label`, `@react-spectrum/form`, `@react-spectrum/progress`, `@react-spectrum/overlays`, `@react-spectrum/layout`, `@react-aria/visually-hidden`, `@react-spectrum/textfield`.
