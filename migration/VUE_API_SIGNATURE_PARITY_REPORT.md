...
* Compared exports: 62
* Mismatched signatures: 11
* Missing in target: 0
* Example mismatches: `useDrag [call-signatures]`, `useDrop [call-signatures]`, `useDroppableCollection [call-signatures]`, `useDroppableItem [call-signatures]`, `useDropIndicator [call-signatures]`, `useDraggableItem [call-signatures]`, `useDraggableCollection [call-signatures]`, `useClipboard [call-signatures]`, `isDirectoryDropItem [call-signatures]`, `isFileDropItem [call-signatures]`, `isTextDropItem [call-signatures]`
...
* Compared exports: 23
* Mismatched signatures: 9
* Missing in target: 0
* Example mismatches: `useTableRowGroup [call-signatures]`, `useTable [call-signatures]`, `useTableColumnHeader [call-signatures]`, `useTableRow [call-signatures]`, `useTableHeaderRow [call-signatures]`, `useTableCell [call-signatures]`, `useTableSelectionCheckbox [call-signatures]`, `useTableSelectAllCheckbox [call-signatures]`, `useTableColumnResize [call-signatures]`
...
* Mismatched signatures: 7
* Missing in target: 0
* Example mismatches: `useDatePickerState [call-signatures]`, `useDateFieldState [call-signatures]`, `useDateRangePickerState [call-signatures]`, `useTimeFieldState [call-signatures]`, `DateSegment [value-availability]`, `SegmentType [value-availability]`, `FormatterOptions [value-availability]`
...
* Missing in target: 0
* Example mismatches: `useDatePicker [call-signatures]`, `useDateSegment [call-signatures]`, `useDateField [call-signatures]`, `useTimeField [call-signatures]`, `useDateRangePicker [call-signatures]`, `useDisplayNames [call-signatures]`

### @react-aria/grid -> @vue-aria/grid

* Source entry: `packages/@react-aria/grid/src/index.ts`
* Target entry: `packages/@vue-aria/grid/src/index.ts`
* Compared exports: 20
* Mismatched signatures: 6
* Missing in target: 0
* Example mismatches: `useGrid [call-signatures]`, `useGridRow [call-signatures]`, `useGridCell [call-signatures]`, `useGridSelectionCheckbox [call-signatures]`, `useHighlightSelectionDescription [call-signatures]`, `useGridSelectionAnnouncement [call-signatures]`
