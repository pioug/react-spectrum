...
| `@react-aria/dialog` | `@vue-aria/dialog` | missing | 3 | 1 | 66.7% |
| `@react-aria/disclosure` | `@vue-aria/disclosure` | missing | 3 | 1 | 66.7% |
| `@react-aria/listbox` | `@vue-aria/listbox` | missing | 12 | 1 | 91.7% |
...
| `@react-stately/form` | `@vue-stately/form` | ok | 7 | 0 | 100.0% |
| `@react-stately/grid` | `@vue-stately/grid` | ok | 4 | 0 | 100.0% |
| `@react-stately/layout` | `@vue-stately/layout` | ok | 9 | 0 | 100.0% |
| `@react-stately/list` | `@vue-stately/list` | ok | 8 | 0 | 100.0% |
